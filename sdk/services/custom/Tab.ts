...
/**
 * Api services for the `Tab` model.
 */
@Injectable()
export class TabApi extends BaseLoopBackApi {
   ...
   *  - `status` – `{object}` - 
   */
  public updateStatus(tabId: any = {}, status: any = {}, url: any = {}, customHeaders?: Function): Observable<any> {
    ...
    let _postBody: any = {};
    let _urlParams: any = {};
    if (typeof tabId !== 'undefined' && tabId !== null) _urlParams.tabId = tabId;
